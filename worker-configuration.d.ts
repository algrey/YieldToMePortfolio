/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: a22feefac3a13a74e57422ab893559a3)
// Runtime types generated with workerd@1.20260515.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	YIELDTOME_RUNTIME_ENV: "preview" | "production" | "local";
	YIELDTOME_WORKERS_PLAN: "free" | "paid";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "YIELDTOME_RUNTIME_ENV" | "YIELDTOME_WORKERS_PLAN" | "MARKET_DATA_PROVIDER" | "CLOUDFLARE_ACCESS_ISSUER" | "CLOUDFLARE_ACCESS_AUDIENCE">> {}
}
