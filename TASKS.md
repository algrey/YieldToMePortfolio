...
Status: READY (2026-08-21, owner directive: "add the graph under the 'Average cost × quantity' section. At the bottom of the graph: Day, week, month, YTD, FY, Year, 5 Year, All" — motivated by the freshly imported 28-year FMG price history being invisible). Rulings:
