...
Status: READY (2026-08-21). Owner rulings: no premium subscription (live-confirmed 2026-08-21: authenticated entitlement 200, loggedIn=true, activeSubscriptionCount=0 — cookies in .dev.vars WORK); "make it configurable: logged in, not logged in, or sharesight." Scope:
