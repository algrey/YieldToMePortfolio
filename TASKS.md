...
Status: READY (2026-08-23, owner directive, verbatim): "In holdings, for any ticker row that has sold shares, there should be a forth line. On the left column on the fourth line it should say 'Realised:' and then have the realised capital followed by the gain expressed as a percent of the basis at the time of the gain. Example: 'Realised: +$15000 (+13.91%)'." SEQUENCING: after UI-029 commits (shared holdings-shell surfaces).
